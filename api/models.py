...
class Location(models.Model):
    ...
    latitude = models.FloatField(null=False, default=99929.124)
    longitude = models.FloatField(null=False, default=0)
    accuracy = models.FloatField(null=True)
    speed = models.FloatField(null=True)
    altitude = models.FloatField(null=True)
    bearing = models.IntegerField(null=True)
    isFromMockProvider = models.BooleanField(null=True, max_length=20)
    mockLocationsEnabled = models.BooleanField(null=True, max_length=20)
